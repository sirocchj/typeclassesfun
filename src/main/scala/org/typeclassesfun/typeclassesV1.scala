...
object typeclassesV1 {
  ...
  object Json {
    ...
    def toJson[A: JsonConverter](a: A): JsValue = implicitly[JsonConverter[A]] convert a
  }
  ...
  def main(args: Array[String]): Unit = {
    ...
    import org.typeclassesfun.typeclassesV1.Json._
    implicit val jsonConverter = expressionJsonConverter

    val json = toJson(expression)
    val jsonString = stringify(json)

    import org.typeclassesfun.typeclassesV1.Evaluator._
